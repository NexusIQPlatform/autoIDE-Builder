...
export VSCODE_CLI_UPDATE_ENDPOINT="https://raw.githubusercontent.com/NexusIQPlatform/versions/refs/heads/main" # Void

if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/NexusIQPlatform/autoIDE-insiders/releases"
else
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/NexusIQPlatform/autoIDE/releases" # Void
fi
