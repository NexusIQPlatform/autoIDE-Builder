...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  PRODUCT_NAME="AutoIDE - Insiders"
  PRODUCT_CODE="AutoIDEInsiders"
  ...
  PRODUCT_NAME="AutoIDE"
  PRODUCT_CODE="AutoIDE"
...
if [[ -z "${1}" ]]; then
	OUTPUT_BASE_FILENAME="AutoIDE-${VSCODE_ARCH}-${RELEASE_VERSION}"
else
	OUTPUT_BASE_FILENAME="AutoIDE-${VSCODE_ARCH}-${1}-${RELEASE_VERSION}"
fi
